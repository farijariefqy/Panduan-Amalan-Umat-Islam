...
public class ViewPagerAdapter3 extends RecyclerView.Adapter<ViewPagerAdapter3.ViewHolder> {
    ...
    private int[] colorArray = new int[]{ R.drawable.c1, R.drawable.c2,R.drawable.c3,
            R.drawable.c4,R.drawable.c5};

    ViewPagerAdapter3(Context context, List<String> data, ViewPager2 viewPager3) {
        ...
        ViewHolder(View itemView) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(viewPager3.getOrientation() == ViewPager2.ORIENTATION_VERTICAL)
